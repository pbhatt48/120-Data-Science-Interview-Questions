...
#### 3. What is the curse of dimensionality?
  ...
  - [readings - I](https://www.mygreatlearning.com/blog/understanding-curse-of-dimensionality/) 
  - As the number of features or dimensions grows, the amount of data we need to generalize accurately grows exponentially.
  - [readings - II](https://www.kdnuggets.com/2017/04/must-know-curse-dimensionality.html)
...
#### 8. How can you determine which features are the most im- portant in your model?
  ...
  - [Readings](https://www.quora.com/How-do-you-determine-feature-importance-in-a-predictive-model)
    ...
    - Information Gain, also referred to as Mutual Information, helps us to measure the dependence between the two variables.
...
In case of a classification task, we measure the dependence between our feature and the target variable. If there exists a dependence, then we select that feature for our classification tasks. Also, it can be used only on discrete features and hence for numeric features discretization is necessary prior to computing Information Gain.
    - What Is Information Gain? Ans: Information Gain, or IG for short, measures the reduction in entropy or surprise by splitting a dataset according to a given value of a random variable. A larger information gain suggests a lower entropy group or groups of samples, and hence less surprise.
    - [Readings](https://machinelearningmastery.com/information-gain-and-mutual-information/)
